...
The data User has rights to use the data only within the framework of the WILDCARD HE project exclusively for purposes specified in the EuFoRIa WILDCARD Project Proposal ….A?, B?…. 
...
2.	All Data providers are offered co-authorship provided that they also contribute to the process of manuscript writing and/or revision and editing before submission. 
